...
SELECT cron.unschedule('exchange-match-sweep') WHERE EXISTS (SELECT 1 FROM cron.job WHERE jobname = 'exchange-match-sweep');
SELECT cron.schedule(
  'exchange-match-sweep',
  '*/10 * * * *',
  $$
  SELECT net.http_post(
    url := 'https://project--dd9b0412-ab83-4f6e-86a4-cd1dedd921cc.lovable.app/api/public/hooks/exchange-match',
