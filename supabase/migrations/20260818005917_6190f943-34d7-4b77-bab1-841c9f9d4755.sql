...
SELECT cron.unschedule('dlq-zip-recovery') WHERE EXISTS (SELECT 1 FROM cron.job WHERE jobname = 'dlq-zip-recovery');
...
SELECT cron.schedule(
  ...
  SELECT net.http_post(
    url := 'https://project--dd9b0412-ab83-4f6e-86a4-cd1dedd921cc.lovable.app/api/public/hooks/dlq-zip-recovery',
